...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NavGroup = __webpack_require__(159);
	    ...
	    buildFromSettings: function buildFromSettings() {
	        ...
	        return this.props.navs.map(function (navkind) {
	            ...
	            if (navkind.navlist) {
	                ...
	                return _react2.default.createElement(_Nav2.default, _extends({
	                    type: _this.props.navtype,
	                    key: navkind.id,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Nav = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        var navClassName = _props.navClassName;
	        var activeNavClassName = _props.activeNavClassName;
	
	
	        var Item = (ITEM_MAP[type] ? ITEM_MAP[type] : this.props.navrenderer) || _Items.IconLeft;
	
	        var classes = (0, _classnames2.default)(_style2.default['sidenav-item'], navClassName, _defineProperty({}, activeNavClassName || _style2.default['active'], isActive(this.props)));
	        return _react2.default.createElement(
	            'div',
